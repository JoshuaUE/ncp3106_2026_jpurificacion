...
// Unsplash Images (kept as‑is; replace with local officer photos if desired)
const IMAGES = [
...
export default function IntroAnimation() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      mouseX.set(normalizedX * 100); // +/-100px
    };
  ...
  // --- Random Scatter Positions (memoized) ---
  ...
  // --- Content Opacity for intro text ---
